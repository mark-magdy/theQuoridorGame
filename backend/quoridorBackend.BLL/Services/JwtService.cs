...
public class JwtService : IJwtService
{
    ...
    public JwtService(IConfiguration configuration)
    {
        ...
        _issuer = _configuration["Jwt:Issuer"] ?? "QuoridorApi";
        _audience = _configuration["Jwt:Audience"] ?? "QuoridorClient";
        _expirationMinutes = int.Parse(_configuration["Jwt:ExpirationMinutes"] ?? "720"); // Default 12 hours
    }
